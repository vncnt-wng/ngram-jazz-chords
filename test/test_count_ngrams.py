...
from count_ngrams import count_ngrams_in_form

def test_count_ngrams_unigram():
    form = ["Dm7", "G7", "Dm7", "C6"]
    store = NGramStore(1)
    count_ngrams_in_form(form, store, 1)
...
def test_count_ngrams_trigram():
    form = ["Dm7", "G7", "Dm7", "C6"]
    store = NGramStore(3)
    count_ngrams_in_form(form, store, 3)
...
def test_count_ngrams_key_invariance():
    form = ["Dm7", "G7", "Dm7", "C6"]
    store = NGramStore(3)
    count_ngrams_in_form(form, store, 3, key_invariant=True)
